    ...
    vec![
        ...
        PatternPatch {
            ...
            ..PatternPatch::new(
                "P1 (cloud rewrite skip)",
                &[
                    0x85, 0xC0, 0x0F, 0x85, 0x00, 0x00, 0x00, 0x00, 0x44, 0x39, 0x25, 0x00, 0x00,
                    0x00, 0x00, 0x00, 0x00,
                ],
                &[
        ...
        PatternPatch {
            ...
            ..PatternPatch::new(
                "P2 (proxy appid zero)",
                &[
                    0x4C, 0x8B, 0xF8, 0x4C, 0x8B, 0xC6, 0x48, 0x8B, 0x54, 0x24, 0x30, 0x48, 0x8B,
                    0xC8, 0xE8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x49,
                    0x8D, 0x14, 0x37, 0x48, 0x81, 0xF9, 0x80, 0x00, 0x00, 0x00,
                ],
                &[
    ...
    vec![
        ...
        PatternPatch {
            ...
            ..PatternPatch::new(
                ...
                &[
                    0x4C, 0x3B, 0xC0, 0x75, 0x17, 0x4D, 0x85, 0xC0, 0x74, 0x09, 0xE8, 0x00, 0x00,
                    0x00, 0x00, 0x85, 0xC0, 0x75, 0x09, 0xC6, 0x05,
                ],
                &[
