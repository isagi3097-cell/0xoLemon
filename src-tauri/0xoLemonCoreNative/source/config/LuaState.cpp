...
namespace LuaLoader::Internal {
    ...
    std::unordered_map<AppId_t, AppId_t>     g_depotToParentApp{};
    ...
    void ParseSession::recordDepot(AppId_t id) {
        ...
        if (parentAppId != 0) {
            g_depotToParentApp[id] = parentAppId;
        }
    ...
    namespace {
        ...
        constexpr Binding kBindings[] = {
            ...
            {"steamlessapply",       &Bind_steamlessApply},
            {"steamlessrestore",     &Bind_steamlessRestore},
        };
    ...
    bool Initialize() {
        ...
        constexpr std::pair<const char*, const char*> kCamelAliases[] = {
            ...
            {"steamlessApply",       "steamlessapply"},
            {"steamlessRestore",     "steamlessrestore"},
        };
