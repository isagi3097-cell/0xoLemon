...
namespace LuaLoader::Internal {
    ...
    // Maps depot or DLC AppIds back to the root game AppId that introduced them.
    extern std::unordered_map<AppId_t, AppId_t>     g_depotToParentApp;
