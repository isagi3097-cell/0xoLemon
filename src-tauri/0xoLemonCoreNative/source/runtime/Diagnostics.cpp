...
namespace Diagnostics {
    ...
    namespace {
        ...
        // Resolve <AppData Roaming>\\SteaMidra\\_0xolemoncore_diag.txt.
        ...
        bool ResolveDumpPath(char* out, size_t cap) noexcept {
            ...
            int written = std::snprintf(
                out, cap, "%s\\SteaMidra\\_0xolemoncore_diag.txt", appdataA);
    ...
    bool Dump(const char* reason) noexcept {
        ...
        // Header: _0xoLemonCore version + active SteamID64 + reason + UTC ts.
        ...
        std::fprintf(
            fp,
            "[_0xolemoncore-diag] reason=%s steamid64=%llu ts_ms=%llu entries=%u\n",
            reason ? reason : "?",
...
#endif  // OXOLEMONCORE_DIAGNOSTICS_ENABLED
