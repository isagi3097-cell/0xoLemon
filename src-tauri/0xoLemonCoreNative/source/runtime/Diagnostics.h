...
// shipped Release builds. The ring lives behind OXOLEMONCORE_DIAGNOSTICS_ENABLED
...
namespace Diagnostics {
    ...
    // <AppData>\\SteaMidra\\_0xolemoncore_diag.txt. Returns true on success,
...
#else  // OXOLEMONCORE_DIAGNOSTICS_ENABLED
