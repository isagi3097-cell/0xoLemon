...
// it runs; once init is done the data gets flushed to <Steam>\_0xolemoncore\status.json
...
namespace StatusWriter {
    ...
    // Writes the accumulated status to <Steam>\_0xolemoncore\status.json. Safe to
