...
namespace PatternFetcher {
    ...
    namespace {
        ...
        HttpResult HttpGet(std::string_view url) {
            ...
            HINTERNET hSession = WinHttpOpen(L"_0xoLemonCore-PatternFetcher/1.0",
        ...
        std::filesystem::path CacheDir() {
            ...
            // Per requirement 2.3 the cache is flat: <Steam>\_0xolemoncore\pattern\
            ...
            return root / "_0xolemoncore" / "pattern";
        }
        ...
        // walk is faster and avoids dragging another dep into _0xoLemonCore.
    ...
    PatternResult LoadFor(HMODULE moduleHandle, const char* subdir) {
        ...
        // If <Steam>\_0xolemoncore\pattern\<sha>.toml exists at startup and parses,
