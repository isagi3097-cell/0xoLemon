...
// table. The public key is hardcoded into _0xoLemonCore so a hostile mirror
...
// or without sidecar .sig files and _0xoLemonCore handles both.
//
...
#ifndef OXOLEMONCORE_PATTERN_SIG_H
#define OXOLEMONCORE_PATTERN_SIG_H
