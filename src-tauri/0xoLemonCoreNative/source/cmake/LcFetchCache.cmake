...
#   cmake -S src -B build -DOXOLEMON_DEPS_DIR=/path/to/shared/cache
#
# Idempotent.
...
if(NOT DEFINED OXOLEMON_DEPS_DIR)
    # CMAKE_CURRENT_LIST_DIR is src/cmake; ../../.deps is the repo root.
    get_filename_component(OXOLEMON_DEPS_DIR
...
foreach(_dep IN ITEMS lua detours spdlog protobuf tomlplusplus)
    ...
    set(_src "${OXOLEMON_DEPS_DIR}/${_dep}-src")
...
if(_LC_ALL_CACHED)
    message(STATUS "FetchContent: reusing cached sources at ${OXOLEMON_DEPS_DIR}")
else()
    ...
    set(FETCHCONTENT_BASE_DIR "${OXOLEMON_DEPS_DIR}" CACHE PATH
        "Shared FetchContent cache (sources + first-time builds)" FORCE)
    message(STATUS "FetchContent: populating missing sources into ${OXOLEMON_DEPS_DIR}")
endif()
