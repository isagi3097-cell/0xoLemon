// _0xoLemonCorePayload — injected into game processes for EOS bridge.
...
#ifdef OXOLEMONCORE_PAYLOAD_LOGGING_ENABLED
...
namespace PayloadLog {
    void Init(HMODULE self) {
        ...
        auto dir = std::filesystem::path(dll).parent_path() / "_0xolemoncore" / "payload";
